...
public class TestServicioUsuario {
    ...
    void testObtenerTodos() {
        ...
        EntidadUsuario usuario2 = new EntidadUsuario(
    		2L, "Luisa Perez", "luisaperez@gmail.com", "contraseña456", "+51 900 000 001"
    	);
    ...
    void testGuardar() {
        EntidadUsuario usuario = new EntidadUsuario(
    		null, "Nuevo Usuario", "nuevo@gmail.com", "password", "+51 912 345 678"
		);
        when(repositorio.save(usuario)).thenReturn(new EntidadUsuario(
    		1L, "Nuevo Usuario", "nuevo@gmail.com", "password", "+51 912 345 678"
		));
